...
for  i =1:K                                 %for each fold  for i = 1 : K
    ...
    Mdl = fitrlinear(DataTrain,AgeTrain,'Regularization','ridge','OptimizeHyperparameters',"Lambda",'HyperparameterOptimizationOptions',struct('KFold',10)); % 'Regularization','ridge' or 'lasso';
...
Mdl_onTest_HC = fitrlinear(MainData,Age_HC_Train_main,'Regularization','ridge','OptimizeHyperparameters',"Lambda",'HyperparameterOptimizationOptions',struct('KFold',10)); % 'Regularization','ridge' or 'lasso';
...
plot(qw,qe,'--k')
fm = gcf;
exportgraphics(fm,'Ridge.png','Resolution',300)
hold on
