...
cvFolds = cvFolds( 1:n ,:);
    ...
    for  i =1:K                                 %for each fold  for i = 1 : K
        ...
        clf0 =GradientBoostingRegressor(struct('loss',loss,'n_estimators',160));
...
clf1=GradientBoostingRegressor(struct('loss',loss,'n_estimators',160));
...
plot(qw,qe,'--k')
fm = gcf;
exportgraphics(fm,'Bagged_Trees.png','Resolution',300)
...
%fprintf("Best parameter for n_estimators is %d\n", n_param);
