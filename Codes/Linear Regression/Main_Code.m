...
Mdl_onTest_HC = fitrlinear(MainData,Age_HC_Train_main); % 'Regularization','ridge' or 'lasso';
...
Mdl_onTest_MCI = fitrlinear(MainData,Age_HC_Train_main);
...
Mdl_onTest_AD = fitrlinear(MainData,Age_HC_Train_main); % 'Regularization','ridge' or 'lasso';
...
plot(qw,qe,'--k')
fm = gcf;
exportgraphics(fm,'Linear_Regression.png','Resolution',300)
hold on
