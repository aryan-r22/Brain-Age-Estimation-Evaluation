...
for  i =1:K                                 %for each fold  for i = 1 : K
    ...
    [u1,u2,~]=lsvm([DataTrain AgeTrain],0.01,0.01,best_t1,best_t1,0.00001,100,1e-5);
...
[u11,u22,~]=lsvm([MainData Age_HC_Train_main],0.01,0.01,best_t1,best_t1,0.00001,100,1e-5);
test1=test_train_regression([MainData Age_HC_Train_main],MainTest_HC,0.01,0.01,0.00001,u11,u22);
...
test2=test_train_regression([MainData Age_HC_Train_main],MainTest_MCI,0.01,0.01,0.00001,u11,u22);
...
%Mdl_onTest_HC = fitrlinear(MainData,Age_HC_Train_main,'Regularization','ridge'); % 'Regularization','ridge' or 'lasso';
test3=test_train_regression([MainData Age_HC_Train_main],MainTest_AD,0.01,0.01,0.00001,u11,u22);
...
plot(qw,qe,'--k')
fm = gcf;
exportgraphics(fm,'LTSVR.png','Resolution',300)
hold on
