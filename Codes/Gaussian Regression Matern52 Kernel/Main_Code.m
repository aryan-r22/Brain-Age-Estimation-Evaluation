...
for  i =1:K                                 %for each fold  for i = 1 : K
    ...
    Mdl = fitrgp(DataTrain, AgeTrain, 'KernelFunction', 'matern52');
...
Mdl_onTest_HC = fitrgp(MainData, Age_HC_Train_main, 'KernelFunction',  'matern52');
...
Mdl_onTest_MCI = fitrgp(MainData,Age_HC_Train_main, 'KernelFunction', 'matern52');
...
Mdl_onTest_AD = fitrgp(MainData,Age_HC_Train_main, 'KernelFunction', 'matern52');
...
plot(qw,qe,'--k')
fm = gcf;
exportgraphics(fm,'Gaussian_Regression_Matern52.png','Resolution',300)
hold on
