...
for  i =1:K                                 %for each fold  for i = 1 : K
    ...
    [u1,u2,D,~]=lsvm([DataTrain AgeTrain],0.01,0.01,best_t1,0.9,best_t2,100,1e-5);
    test=test_train_regression([DataTrain AgeTrain],MainTestData ,best_t1,0.9,u1,u2,D);
...
[u11,u22,D11,~]=lsvm([MainData Age_HC_Train_main],0.01,0.01,best_t1,0.9,best_t2,100,1e-5);
test1=test_train_regression([MainData Age_HC_Train_main],MainTest_HC,best_t1,0.9,u11,u22,D11);
       
PredictTest_HC_Before= test1;
...
test2=test_train_regression([MainData Age_HC_Train_main],MainTest_MCI,best_t1,0.9,u11,u22,D11);
 
PredictTest_MCI_Before= test2;
...
%Mdl_onTest_HC = fitrlinear(MainData,Age_HC_Train_main,'Regularization','ridge'); % 'Regularization','ridge' or 'lasso';
test3=test_train_regression([MainData Age_HC_Train_main],MainTest_AD,best_t1,0.9,u11,u22,D11);
 
PredictTest_AD_Before= test3;
...
plot(qw,qe,'--k')
fm = gcf;
exportgraphics(fm,'RKNNWTSVR.png','Resolution',300)
hold on
