...
load('best_params.mat');
     ...
     %Range for all three parameters is the same
               ...
               FunPara.p3=c3_best;
               FunPara.p4=c3_best;
               FunPara.p5=eps1_best;
               FunPara.p6=eps1_best;
     ...
     d1.X = MainData;
     d1.Y = Age_HC_Train_main;
     PredictTest_HC_Before = ETSVR(MainTest_HC, d1, FunPara);
     ...
     d2.X = MainData;
     d2.Y = Age_HC_Train_main;
     PredictTest_MCI_Before = ETSVR(MainTest_MCI, d2, FunPara);
     ...
     %Mdl_onTest_HC = fitrlinear(MainData,Age_HC_Train_main,'Regularization','ridge'); % 'Regularization','ridge' or 'lasso';
     d3.X = MainData;
     d3.Y = Age_HC_Train_main;
     PredictTest_AD_Before = ETSVR(MainTest_AD, d3, FunPara);
     ...
     plot(qw,qe,'--k')
     fm = gcf;
     exportgraphics(fm,'ETSVR.png','Resolution',300)
     hold on
    ...
    disp("best_param file does not exist. Run Lin_ETSVR_GridSearch.m first");
end