...
for  i =1:K                                 %for each fold  for i = 1 : K
    ...
    Mdl = fitrsvm(DataTrain,AgeTrain,'Standardize',false,'KernelFunction','polynomial','PolynomialOrder',2,'OutlierFraction',0.0); % ,'KernelScale','auto' . false
...
Mdl_onTest_HC = fitrsvm(MainData,Age_HC_Train_main,'Standardize',false,'KernelFunction','polynomial','PolynomialOrder',2,'OutlierFraction',0.0); % ,'KernelScale','auto'
...
Mdl_onTest_MCI = fitrsvm(MainData,Age_HC_Train_main,'Standardize',false,'KernelFunction','polynomial','PolynomialOrder',2,'OutlierFraction',0.0); % ,'KernelScale','auto'
...
%
Mdl_onTest_AD = fitrsvm(MainData,Age_HC_Train_main,'Standardize',false,'KernelFunction','polynomial','PolynomialOrder',2,'OutlierFraction',0.0); % ,'KernelScale','auto'
...
plot(qw,qe,'--k')
fm = gcf;
exportgraphics(fm,'Quadratic_SVR.png','Resolution',300)
hold on
